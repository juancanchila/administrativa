...
let AuthService = class AuthService {
    constructor(http, router, menucontrol) {
        ...
        this.url = 'https://vitac.epacartagena.gov.co/user/login?_format=json';
        this.urlexit = 'https://vitac.epacartagena.gov.co/user/logout=';
        this.urlregister = 'https://vitac.epacartagena.gov.co/user/register?_format=hal_json';
    ...
    getUser(name) {
        ...
        console.log('esto');
        console.log(name);
        this.http.post('https://vitac.epacartagena.gov.co/perfil-de-usuario-json', name, { headers: headers }).subscribe(data2 => {
            console.log(data2);
        }, error2 => {
...
const environment = {
    production: false, urlBase: "https://administrativa.epacartagena.gov.co",
};
/*
...
"use strict";
module.exports = "ion-toolbar {\n  color: white;\n  --ion-background-color: #5DB5E5;\n}\n\nion-button {\n  color: white;\n  --ion-background-color: #5DB5E5 !important;\n}\n\n.button-solid {\n  --ion-background-color: #5DB5E5 !important;\n  --background: #5DB5E5;\n  --color: var(--ion-color-primary-contrast, #fff);\n}\n\n.ion-page {\n  align-items: center;\n}\n\n@media only screen and (min-width: 768px) {\n  /* For desktop: */\n  .content[_ngcontent-ahh-c145] {\n    max-width: 394px;\n    min-width: 200px;\n    margin: auto;\n    padding: 2%;\n    border-radius: 25px;\n    background: #007b3c;\n    /* padding-top: 5%; */\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
